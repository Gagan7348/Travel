      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-600">
            ...
            <p>
              If you have any questions about these Terms, please contact us at <a href="mailto:team@voyagex.com" className="text-blue-600 hover:text-blue-800">team@voyagex.com</a>.
            </p>
          </div>
        </div>
      </div>
