                ...
                <section id="contact" className="mb-10">
                  ...
                  <div className="flex space-x-4 mb-6">
                    <div className="bg-blue-50 p-4 rounded-lg flex-1">
                      ...
                      <p className="text-gray-600 mb-1">Email: <a href="mailto:support@voyagex.com" className="text-blue-600 hover:text-blue-800">support@voyagex.com</a></p>
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg flex-1">
                      ...
                      <p className="text-gray-600 mb-1">Email: <a href="mailto:feedback@voyagex.com" className="text-blue-600 hover:text-blue-800">feedback@voyagex.com</a></p>
