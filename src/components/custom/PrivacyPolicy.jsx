      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-600">
            ...
            <p>
              At VoyageX.com ("we," "our," or "us"), we value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website, mobile application, or any other related services (collectively, the "Service").
            </p>
            <p>
            ...
            <p>
              If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at <a href="mailto:teams@VoyageX.com" className="text-blue-600 hover:text-blue-800">teams@VoyageX.com</a>.
            </p>
          </div>
        </div>
      </div>
