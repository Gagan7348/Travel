      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-600">
            ...
            <p>
              This Cookie Policy explains how VoyageX.com ("we," "our," or "us") uses cookies and similar technologies on our website, mobile application, and other related services (collectively, the "Service"). This Cookie Policy should be read together with our Privacy Policy.
            </p>
            <p>
            ...
            <p>
              If you have any questions or concerns about this Cookie Policy, please contact us at <a href="mailto:privacy@VoyageX.com" className="text-blue-600 hover:text-blue-800">privacy@VoyageX.com</a>.
            </p>
          </div>
        </div>
      </div>
